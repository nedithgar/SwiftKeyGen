...
- [x] Add an InlineArray usage cheat-sheet (init patterns, iteration patterns, unsafe buffer access) at the top of `summary.md` to minimize future accidental misuse; link this cheat-sheet in PR description. (Added unsafe buffer access section & best practices on 2025-09-25)
